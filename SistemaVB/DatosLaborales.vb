Public Class DatosLaborales
    ...
    Private Sub DatosLaborales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        btnPerfil.Text = Nombre.ToUpper
    End Sub

    Private Sub btndatlab_Click(sender As Object, e As EventArgs) Handles btndatlab.Click
        Dim _AdscripcionExterna As DatosLaborales__AdscripcionExterna = New DatosLaborales__AdscripcionExterna()
        _AdscripcionExterna.Show()
        Me.Close()
    End Sub
End Class